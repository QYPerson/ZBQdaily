...
+(instancetype)customCycleScrollViewWithFrame:(CGRect)frame imageURLStringsGroup:(NSArray *)imageURLsGroup{
    SDCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
    //轮播器滚动时间间隔 当前页背景色 字体大小 label高度 背景色
    cycleScrollView.imageURLStringsGroup = [NSMutableArray arrayWithArray:imageURLsGroup];
    cycleScrollView.autoScrollTimeInterval = 5;
    cycleScrollView.currentPageDotColor = [UIColor yellowColor];
    cycleScrollView.titleLabelTextFont = [UIFont systemFontOfSize:21];
    cycleScrollView.titleLabelHeight = 120;
